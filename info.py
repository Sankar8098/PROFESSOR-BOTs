...
FORCE_SUB_TEXT = environ.get('FORCE_SUB_TEXT', 'SK_MoviesOffl')
...
# Others
IMDB_DELET_TIME = int(environ.get('IMDB_DELET_TIME', "6500"))
...
INDEX_REQ_CHANNEL = int(environ.get('INDEX_REQ_CHANNEL', -1001870015374))
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001818253894')).split()]
